...
const translations = {
  en: {
    ...
    'header.jooy_app': 'Jooy App',
    'header.jooy_app_tooltip': 'Open Jooy App in new tab',
    ...
    // TTS Request Modal
    'tts.request_tutor_for': 'Request Virtual Tutor for',
    'tts.select_pages_description': 'Select the pages for which you want to generate a virtual tutor session. The document has',
    'tts.document_pages': 'pages.',
    'tts.loading_document': 'Loading document details...',
    'tts.load_pdf_error': 'Could not load PDF details. Please try again.',
    'tts.failed_load_document': 'Failed to load document information. Please close this and try again.',
    'tts.pages_label': 'Pages',
    'tts.pages_placeholder': 'e.g., 1, 3-5, 8',
    'tts.voice_label': 'Voice',
    'tts.voice_female': 'Female',
    'tts.voice_male': 'Male',
    'tts.select_all_pages': 'Select all pages',
    'tts.total_pages_selected': 'Total pages selected:',
    'tts.your_credits': 'Your credits:',
    'tts.credits_used': 'Credits that will be used:',
    'tts.credits_needed': 'Credits needed:',
    'tts.insufficient_credits': 'Insufficient Credits',
    'tts.submitting': 'Submitting...',
    'tts.submit_for_credits': 'Submit for {count} credits',
  ...
  ar: {
    ...
    'header.jooy_app': 'تطبيق جُويْ',
    'header.jooy_app_tooltip': 'فتح تطبيق جُويْ في نافذة جديدة',
    ...
    // TTS Request Modal
    'tts.request_tutor_for': 'طلب معلم افتراضي لـ',
    'tts.select_pages_description': 'اختر الصفحات التي تريد إنشاء جلسة معلم افتراضي لها. يحتوي المستند على',
    'tts.document_pages': 'صفحة.',
    'tts.loading_document': 'جارٍ تحميل تفاصيل المستند...',
    'tts.load_pdf_error': 'لا يمكن تحميل تفاصيل PDF. يرجى المحاولة مرة أخرى.',
    'tts.failed_load_document': 'فشل في تحميل معلومات المستند. يرجى إغلاق هذا والمحاولة مرة أخرى.',
    'tts.pages_label': 'الصفحات',
    'tts.pages_placeholder': 'مثل: 1، 3-5، 8',
    'tts.voice_label': 'الصوت',
    'tts.voice_female': 'أنثى',
    'tts.voice_male': 'ذكر',
    'tts.select_all_pages': 'اختيار جميع الصفحات',
    'tts.total_pages_selected': 'إجمالي الصفحات المحددة:',
    'tts.your_credits': 'أرصدتك:',
    'tts.credits_used': 'الأرصدة التي سيتم استخدامها:',
    'tts.credits_needed': 'الأرصدة المطلوبة:',
    'tts.insufficient_credits': 'أرصدة غير كافية',
    'tts.submitting': 'جارٍ الإرسال...',
    'tts.submit_for_credits': 'إرسال مقابل {count} أرصدة',
